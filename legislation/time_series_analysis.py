...
def get_or_generate_data(filename='legislation/unique_dates_counts.csv', n_samples=353):
...
def main():
    ...
    report_path = 'legislation/time_series_analysis_report.md'
    with open(report_path, 'w') as f:
        f.write(report)
    
    print("\nAnalýza dokončená!")
    print(f"Vizualizácie uložené do adresára '{output_dir}'")
    print(f"Správa uložená ako '{report_path}'")
