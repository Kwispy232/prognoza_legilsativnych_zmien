...
output_dir = 'train/visualizations'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

def load_and_prepare_data(filename='train/train_scraped_entries.csv'):
    """
    ...
    sorted_filename = 'train/sorted_train_entries.csv'
...
def generate_report(df, is_stationary, seasonal_results, strongest_period, recommendations):
    ...
    # Save report
    report_text = '\n'.join(report)
    report_file = 'train/train_data_analysis_report.md'
